...
export const SITE = {
  ...
  deliveryFee: 25,
  social: {
    instagram: { handle: "@shopklark", url: "https://instagram.com/shopklark" },
    tiktok: { handle: "@shopklark", url: "https://tiktok.com/@shopklark" },
    snapchat: { handle: "@shopklark", url: "https://snapchat.com/add/shopklark" },
  },
};
...
// NOTE: getProductBySlug, getFeaturedProducts, getRelatedProducts, etc. now
// live in src/lib/products.ts and query the database. PRODUCTS below is kept
// only as the seed source for `npx prisma db seed` — see prisma/seed.ts.
